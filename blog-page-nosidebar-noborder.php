            ...
            <?php while (have_posts()) : the_post(); ?>
                <div class="post-single">
                    <div class="single-category">
                      ...
                      <?php if(get_kizumi('kizumi_like_switch') || get_kizumi('kizumi_reward_switch')): ?>
                      <div class="post-actions mt-4">
                        <?php if(get_kizumi('kizumi_like_switch')): ?>
                          ...
                          <?php endif; ?>
                          <?php if(get_kizumi('kizumi_reward_switch')): ?>
                          ...
                          <div class="reward-content">
                              ...
                              <div class="reward-body">
                                  <div class="qrcode-item">
                                      <?php if(get_kizumi('kizumi_reward_qrcode_weixin')): ?>
                                      <img src="<?php echo get_kizumi('kizumi_reward_qrcode_weixin'); ?>" alt="微信赞赏" >
                                      <p>微信扫一扫</p>
                                      <?php endif; ?>
                                  </div>
                                  <div class="qrcode-item">
                                      <?php if(get_kizumi('kizumi_reward_qrcode_alipay')): ?>
                                      <img src="<?php echo get_kizumi('kizumi_reward_qrcode_alipay'); ?>" alt="支付宝赞赏">
                                      <p>支付宝扫一扫</p>
                                      <?php endif; ?>
                                  </div>
                              </div>
