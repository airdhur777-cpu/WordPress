...
class Options_Framework_Admin {
	...
	static function menu_settings() {
		...
		$menu = array(
            ...
            'page_title' => __( 'Kizumi主题', 'textdomain' ),
			'menu_title' => __('Kizumi', 'textdomain'),
			'capability' => 'edit_theme_options',
			'menu_slug' => 'kizumi_options',
	 ...
	 function options_page() { ?><?php $menu = $this->menu_settings(); ?>
	  ...
	  <?php settings_errors( 'options-framework' ); ?> 
		<div class="set-main-plane">
			...
			<div class="kizumi-options-site-name">
			<span class="dashicons dashicons-nametag"></span> Kizumi主题     <svg width="24" height="24" viewBox="0 0 24 24">
		...
		<a href="https://docs.kizumi.mysqil.com/" target="_blank" rel="external nofollow" class="el-button">
