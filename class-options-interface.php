	...
	static function optionsframework_fields() {
		...
		foreach ( $options as $value ) {
			...
			if ( ( $value['type'] != "heading" ) && ( $value['type'] != "info" ) ) {
				...
				if (isset($value['group']) && $value['group'] == 'start') {
					...
					if (isset($value['group_title'])) {
						$output .= '<div class="kizumi_tab_header"><span class="dashicons dashicons-info-outline"></span> ' . esc_html($value['group_title']) . '</div>' . "\n";
					}
				}
				...
				if ($group_opened) {
				$output .= '<div class="kizumi_group_opened">' . "\n";
				}		
				if ( isset( $value['name'] ) ) {
			...
			case "heading":
				...
				$output .= '<div class="kizumi_tab_header"><span class="dashicons dashicons-wordpress"></span> ' . esc_html( $value['name'] ) . '</div>' . "\n";
				break;
			}
