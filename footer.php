...
<footer class="mt-7">
    <hr class="horizontal dark">
      <div class="container pb-4">
        ...
        <?php echo kizumi_load_assets_footer(); ?>
      </div>
    </footer>
    ...
    <div class="floating-action-menu">
      <nav class="floating-menu-items">
        <ul>
          ...
          <?php endif; ?>
          <?php if(get_kizumi('kizumi_lolijump_switch')): ?>
          <li>
            <a id="lolijump" href="#" title="返回顶部">
              <img src="<?php echo kizumi_theme_url(); ?>/assets/images/top/<?php echo get_kizumi('kizumi_lolijump_img'); ?>.gif" alt="返回顶部"></a>
          </li>
          <?php endif; ?>
        </ul>
      </nav>
    ...
    ?>
    <?php echo get_kizumi('kizumi_diy_code_footer'); ?>
  </body>
</html>