...
// 可视化编辑器添加下拉式按钮
function kizumi_select(){
echo '
<select id="short_code_select">
    <option value="短代码选择！">kizumi短代码</option>
...
if (current_user_can('edit_posts') && current_user_can('edit_pages')) {
	add_action('media_buttons', 'kizumi_select', 11);
}
//ctlr+enter回复
function kizumi_button() {
...
add_action('admin_head', 'kizumi_button');
