...
<html <?php language_attributes(); ?>>
    ...
    <title><?php echo kizumi_theme_title(); ?></title>
    <link rel="icon" href="<?php echo kizumi_favicon(); ?>" type="image/x-icon">
    <?php kizumi_keywords(); ?>
    <?php kizumi_description(); ?>
    <?php ob_start();wp_head();$wp_head_output = ob_get_clean();echo preg_replace('/\n/', "\n    ", trim($wp_head_output))."\n    ";?>
    <?php if (get_kizumi('kizumi_banner_height_switch')){ kizumi_banner_height_load(); }?>
</head>
  <body<?php if(get_kizumi('kizumi_hdr_color_switch')): ?> class="body_color"<?php endif; ?>>
  <?php if(get_kizumi('kizumi_page_loading_switch')): ?>  
    <div class="preloader">
      <svg version="1.1" id="kizumi-sakura" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="80" height="80" viewBox="0 0 80 80" style="enable-background:new 0 0 80 80;" xml:space="preserve">
         <g id="sakura">
  ...
  <?php kizumi_festival_lantern(); ?>
  <header class="kizumi_header">
      <nav class="navbar navbar-expand-lg  w-100">
        <div class="container d-flex justify-content-between align-items-center">
          ...
          <div class="d-flex d-lg-none align-items-center">
            ...
            <?php if(is_user_logged_in() && get_kizumi('kizumi_sign_in_link_switch')): ?>
            <div class="mobile-user-panel">
              <div class="user-panel-content">
                <div class="mobile-user-wrapper">
                  <div class="mobile-logged-menu">
                    <a href="<?php echo kizumi_user_center_link_page(); ?>" class="mobile-menu-item">
            ...
            <div class="mobile-user-panel">
              <div class="user-panel-content">
                ...
                <a href="<?php echo kizumi_sign_in_link_page(); ?>" class="user-login">
                <span class="login-text">登录</span></a>
                </div>
                <span class="divider">or</span>
                <div class="user-reg-wrap">
                <a href="<?php echo kizumi_sign_up_link_page(); ?>" class="user-reg">
                <span class="reg-text">注册</span></a></div>
                <img src="<?php echo kizumi_theme_url(); ?>/assets/images/up-new-iocn.png" class="new-tag" alt="up-new-iocn">
                </div>
                  </div>
                </div>
              </div>
          ...
          <div class="offcanvas offcanvas-start offcanvas-nav width">
            ...
            <div class="mobile-logged-user-wrapper d-block d-lg-none">
              <a href="<?php echo kizumi_user_center_link_page(); ?>" class="user-info-wrap d-flex align-items-center">
                <div class="user-avatar">
                  <img src="<?php echo kizumi_lazy_load_images(); ?>" data-src="<?php echo kizumi_get_avatar_url(get_current_user_id(), 100); ?>" alt="avatar" class="img-fluid rounded-3 lazy">
                </div>
                <div class="user-info">
              ...
              <div class="nav-right-section d-flex align-items-center">
                ...
                <div class="logged-user-wrapper d-none d-lg-flex">
                  <div class="user-info-wrap d-flex align-items-center dropdown">
                    <a href="<?php echo kizumi_user_center_link_page(); ?>" class="dropdown-toggle d-flex align-items-center" data-bs-toggle="dropdown" aria-expanded="false">
                      <div class="user-avatar">
                      <img src="<?php echo kizumi_lazy_load_images(); ?>" data-src="<?php echo kizumi_get_avatar_url(get_current_user_id(), 100); ?>" alt="avatar" class="img-fluid rounded-3 lazy">
                    </div>
                      <div class="user-info">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end">
                      <li>
                        <a class="dropdown-item" href="<?php echo kizumi_user_center_link_page(); ?>">
    ...
    <section class="kizumi_header_banner">
      <div class="kizumi_header_banner_img">
        <img src="<?php  kizumi_banner_image(); ?>" alt="kizumi_header_banner_img">
        <div class="site-main">
          <h2 class="text-gradient"><?php echo kizumi_banner_welcome(); ?></h2>
          <?php echo kizumi_banner_hitokoto(); ?>
        </div>
      </div>
      <div class="kizumi_header_banner_waves">
    ...
    <section class="kizumi-container container">
