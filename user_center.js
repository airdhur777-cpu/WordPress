document.addEventListener('DOMContentLoaded', function() {
    ...
    if (cardForm) {
        cardForm.addEventListener('submit', async function(e) {
            ...
            const formData = new FormData();
            formData.append('action', 'kizumi_form_money_card');
    ...
    if (onlineForm) {
        onlineForm.addEventListener('submit', function(event) {
            ...
            const formData = new FormData();
            formData.append('action', 'kizumi_form_money_online');
    ...
    // 签到功能
    const checkinButton = document.getElementById('kizumi-checkin-today');
    if (checkinButton) {
