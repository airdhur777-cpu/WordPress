...
class widget_userinfo extends WP_Widget {
	...
	function __construct(){
		parent::__construct( 
			...
			'kizumi_用户信息', 
			array( 
				'description' => __('用户信息侧栏小工具', 'kizumi-com'),
				'classname'   => __('widget-userinfo', 'kizumi-com')
			) 
		);
	}
	...
	public function widget( $args, $instance ) {
		...
		$avatar_url = kizumi_get_avatar_url($avatarid, 100);
		echo $before_widget;
...
if ( is_user_logged_in() ) {
    ...
    $user_center_url = home_url('/login');
}

echo '
<div class="widget-profile">
    <div class="profile-avatar">
        <a href="' . esc_url($user_center_url) . '" title="用户中心">
            <img src="'.kizumi_lazy_load_images().'" class="lazy" data-src="'.esc_url($avatar_url).'" alt="avatar">
        </a>
    </div>
	...
	public function form( $instance ) {
		...
		<p>
			<label>
				...
				<?php echo __('显示GitHub图标', 'kizumi-com') ?>
			</label>
		</p>
		<p>
			<label>
				...
				<?php echo __('显示Telegram图标', 'kizumi-com') ?>
			</label>
		</p>
		<p>
			<label>
